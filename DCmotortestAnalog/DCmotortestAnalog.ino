...
void loop() {
  ...
  // Drive motor A and B Forward at a speed proportional to
  //the analog sensor input  
  //phototransistor
  driveArdumoto(MOTOR_A, FORWARD, aval*255/MAXAVAL); // Set motor A to run at half
  driveArdumoto(MOTOR_B, FORWARD, aval*255/MAXAVAL);  // Set motor B to FORWARD at half
